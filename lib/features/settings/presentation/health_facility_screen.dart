...
class HealthFacilityScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HealthFacilityScreen> createState() =>
      _HealthFacilityScreenState();
}

class _HealthFacilityScreenState extends ConsumerState<HealthFacilityScreen> {
  ...
  void initState() {
    ...
    _phoneController =
        TextEditingController(text: widget.facility?.phone ?? '');
  }
  ...
  Future<void> _save() async {
    ...
    if (saved) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(localizations.healthFacilitySaveError)),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bool isSaving = ref.watch(healthFacilityControllerProvider).isLoading;
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(
                localizations.healthFacilityTitle,
              ...
              Text(
                localizations.healthFacilitySubtitle,
                style: const TextStyle(fontSize: 16, color: Color(0xFF64748B)),
              ),
              const SizedBox(height: 32),
              _buildTextField(
                label: localizations.healthFacilityName,
              ...
              _buildTextField(
                label: localizations.healthFacilityAddress,
              ...
              const SizedBox(height: 24),
              _buildTextField(
                label: localizations.healthFacilityPhone,
                hint: localizations.healthFacilityPhoneHint,
              ...
              ElevatedButton(
                ...
                child: isSaving
                    ...
                    : Text(
                        localizations.healthFacilitySave,
                        style: const TextStyle(
                          fontSize: 18,
